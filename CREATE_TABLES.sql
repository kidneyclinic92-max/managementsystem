...
-- Copy and paste this entire script into Azure Portal Query Editor
-- ============================================
...
BEGIN
    ...
    PRINT 'Table "cycle_counts" created successfully';
END
ELSE
BEGIN
    PRINT 'Table "cycle_counts" already exists';
END;
...
BEGIN
    ...
    PRINT 'Table "replenishment_requests" created successfully';
END
ELSE
BEGIN
    PRINT 'Table "replenishment_requests" already exists';
END;
